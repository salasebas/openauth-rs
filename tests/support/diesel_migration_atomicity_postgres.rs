//! Postgres migration rollback assertions for Diesel adapter integration tests.
...
pub async fn assert_diesel_postgres_migration_plan_rolls_back(
    adapter: &rustauth_diesel::DieselPostgresAdapter,
    pool: &sqlx::PgPool,
    schema: &DbSchema,
