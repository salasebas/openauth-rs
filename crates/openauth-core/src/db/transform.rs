...
pub fn transform_create_query(schema: &DbSchema, query: Create) -> Result<Create, OpenAuthError> {
...
pub fn transform_count_query(schema: &DbSchema, query: Count) -> Result<Count, OpenAuthError> {
...
pub fn transform_update_query(schema: &DbSchema, query: Update) -> Result<Update, OpenAuthError> {
...
pub fn transform_update_many_query(
    schema: &DbSchema,
    query: UpdateMany,
) -> Result<UpdateMany, OpenAuthError> {
...
pub fn transform_delete_query(schema: &DbSchema, query: Delete) -> Result<Delete, OpenAuthError> {
...
pub fn transform_delete_many_query(
    schema: &DbSchema,
    query: DeleteMany,
) -> Result<DeleteMany, OpenAuthError> {
...
pub fn resolve_join_options(
    ...
    select: Vec<String>,
    default_limit: usize,
) -> Result<JoinResolution, OpenAuthError> {
...
fn resolve_join_config(
    ...
    option: JoinOption,
    default_limit: usize,
) -> Result<ResolvedJoinConfig, OpenAuthError> {
...
) -> Result<Vec<Where>, OpenAuthError> {
    where_clauses
        .into_iter()
...
fn transform_sort(schema: &DbSchema, model: &str, sort: Sort) -> Result<Sort, OpenAuthError> {
