...
fn client_privileges_error_response() -> Result<ApiResponse, OpenAuthError> {
...
fn trusted_client_error_response() -> Result<ApiResponse, OpenAuthError> {
...
fn verify_oauth_query(oauth_query: &str, secret: &str) -> Result<bool, OpenAuthError> {
