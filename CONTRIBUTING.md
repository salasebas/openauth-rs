...
Record parity status in the crate README (see [`docs/parity/README.md`](docs/parity/README.md)
for the index).
...
6. Update the crate README parity section when behavior, gaps, or test coverage
   change.
